...
public class CinemaInitServiceImpl implements ICinemaInitService{
    ...
    public void initVilles() {
        Stream.of("Casablanca", "Marrakech", "oujda", "Rabat").forEach(v -> {
    ...
    public void initCinemas() {
        villeRepository.findAll().forEach(ville -> {
            Stream.of("MegaRAMA", "IMAX", "La Renaissance", "Cineatlas").forEach(cinemaName -> {
    ...
    public void initFilms() {
        ...
        Stream.of("Game of Thrones ", "The Mother", "AKA", "SpiderMan").forEach(filmTitre -> {
            Film film = new Film();
